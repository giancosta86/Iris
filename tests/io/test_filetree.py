...
class FileTreeTestCase(AbstractIoTestCase):
    def setUp(self):
        ...
        shutil.copytree(
            os.path.join(self._ioTestPath, "filetree"), self._tempFileTreePath
        )
...
class HeaderRemoverTests(FileTreeTestCase):
    ...
    def testApplyTo_WithJavaFile(self):
        ...
        with open(
            os.path.join(self._tempFileTreePath, "alpha", "beta", "lambda.java"), "r"
        ) as sourceFile:
    ...
    def testApplyTo_WithPlainTextFile(self):
        ...
        with open(
            os.path.join(self._tempFileTreePath, "alpha", "beta", "mi.txt"), "r"
        ) as sourceFile:
            lines = sourceFile.readlines()
    ...
    def testApplyTo_WithJavaFileHavingNoHeader(self):
        ...
        with open(
            os.path.join(self._tempFileTreePath, "alpha", "beta", "ni.java"), "r"
        ) as sourceFile:
            lines = sourceFile.readlines()
...
class TrailingSpaceRemoverTests(FileTreeTestCase):
    def setUp(self):
        ...
        self._trailingSpaceRemover = TrailingSpaceRemover(r".*\.(java|cs|js|c|cpp)$")

    def testApplyTo_WithJavaFile(self):
        self._trailingSpaceRemover.applyTo(self._tempFileTreePath)

        with open(
            os.path.join(self._tempFileTreePath, "gamma", "spaces.java"), "r"
        ) as sourceFile:
    ...
    def testApplyTo_WithPlainTextFile(self):
        ...
        with open(
            os.path.join(self._tempFileTreePath, "gamma", "spaces.txt"), "r"
        ) as sourceFile:
            processedLines = sourceFile.readlines()
